package github.hemathajay.com.androidlibrary_expandabletextview;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener  {
    ...
    @IdRes
    private int mExpandableTextId = R.id.description;
    ...
    private void init(AttributeSet attrs) {
        ...
        mExpandableTextId = typedArray.getResourceId(R.styleable.ExpandableTextView_expandableTextId, R.id.description);
